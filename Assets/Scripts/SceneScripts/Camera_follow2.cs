...
public class Camera_follow2 : MonoBehaviour
{
    ...
    void follow()
    {
        Vector3 targetPosition = new Vector3(target.position.x, -0.5f, transform.position.z); //2.18f is the offset for the camera to follow the player at ground level
